...
<!-- need to figure out the for-each to add 264 Jen 04/08/2014	-->
		...
		<!-- 043 added by Karen -->
		<xsl:if test="marc:datafield[@tag='600' or @tag='610' or @tag='650' or @tag='651' or @tag='653' or @tag='043']">
			<xsl:call-template name="comment">
			...
			<vra:subjectSet>
				<vra:display>
					<xsl:for-each
					    ...
					    marc:datafield[@tag='610']/marc:subfield[@code='a' or @code='g'] | marc:datafield[@tag='650']/marc:subfield[@code='a' or @code='d'] | 
					    marc:datafield[@tag='651']/marc:subfield[@code='a'] | marc:datafield[@tag='653']/marc:subfield[@code='a'] | marc:datafield[@tag='043']/marc:subfield[@code='a']">
						<xsl:call-template name="displaySeparator"/>
