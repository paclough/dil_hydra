...
<xsl:template match="marc:datafield[@tag='100'or @tag='700']">
	<vra:agent>
		...
		<!-- added by Mike 3/12/2012-->
		  <xsl:if test="//marc:datafield[@tag='046']/marc:subfield[@code='f'] | //marc:datafield[@tag='046']/marc:subfield[@code='g']">
		    <vra:dates type="life">
		      	   <xsl:apply-templates select="//marc:datafield[@tag='046']/marc:subfield[@code='f']"/>
		      	   <xsl:apply-templates select="//marc:datafield[@tag='046']/marc:subfield[@code='g']"/>
		    </vra:dates>
		  </xsl:if>
