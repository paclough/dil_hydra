...
-->
		...
		<!--	<xsl:if test="marc:datafield[@tag='752']/marc:subfield[not(@code='g')] 
		...
		<xsl:if test="marc:datafield[@tag='773' and @ind1='0' and @ind2=' ']/marc:subfield[@code='a' or @code='g']">
			<xsl:call-template name="comment">
			...
			<vra:sourceSet>
				<vra:display>
					<xsl:for-each
						select="marc:datafield[@tag='773' and @ind1='0' and @ind2=' ']/marc:subfield[@code='a' or @code='g']">
						<xsl:call-template name="displaySeparator"/>
						<xsl:value-of select="."/>
					</xsl:for-each>
				</vra:display>
				<xsl:apply-templates select="marc:datafield[@tag='773' and @ind1='0' and @ind2=' ']/marc:subfield[@code='a' or @code='g']"/>
			</vra:sourceSet>
		</xsl:if>
...
<xsl:template match="marc:datafield[@tag='651']">-->
	...
	<!-- SOURCE -->
	<xsl:template match="marc:datafield[@tag='773' and @ind1='0' and @ind2=' ']/marc:subfield[@code='a']">
		<vra:source>
			<vra:name>
				<xsl:value-of select="."/>
			</vra:name>
